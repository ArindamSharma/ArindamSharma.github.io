...
export const PERSONAL_INFO = {
	...
	SOCIAL_LINKS: [
		...
		{
			name: "LinkedIn",
			link: "https://linkedin.com/in/arindamsharma18",
			icon: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/linkedin.svg"
		},
		{
			name: "Twitter",
			link: "https://x.com/ArinDevStar",
	...
	EXPERIENCES: [
		{
			...
			role: "Sr. Associate Software Engineer | Associate Software Engineer",
	...
	ACHIEVEMENTS: [
		{
			id: 1,
			title: "First Position - Chakravyuha (Samgatha 2k18)",
			year: "2018",
			description: "Designed robots for Indian Navy and Army operations, achieving first position in the national competition",
		...
		},
		{
			...
			year: "2022",
			description: "Evolution Simulator using Neural Networks - implementing complex neuron structures and genetic algorithms",
			category: "Academic",
			iconColor: "#8b5cf6",
			icon: "medal",
			images: [
		...
		},
		{
			...
			year: "2020-Present",
			description: "Active contributor to multiple open-source projects with 100+ commits and community recognition",
